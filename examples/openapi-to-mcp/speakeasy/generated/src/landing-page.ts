...
export function landingPageHTML(origin: string): string {
  ...
  const codexConfig = `[mcp_servers.ParcelioMcp]
url = "${o}/sse"
http_headers = { "server-index" = "YOUR_SERVER_INDEX", "api-key-auth" = "YOUR_API_KEY_AUTH", "bearer-auth" = "YOUR_BEARER_AUTH" }`;
...
<head>
    ...
    <title>parcelio-mcp MCP</title>
    <meta name="description" content="Install parcelio-mcp MCP server.">
    <meta property="og:type" content="website">
    <meta property="og:title" content="parcelio-mcp - MCP Server">
    <meta property="og:description" content="Install parcelio-mcp MCP server.">
    <meta property="twitter:card" content="summary">
    <meta property="twitter:title" content="parcelio-mcp - MCP Server">
    <meta property="twitter:description" content="Install parcelio-mcp MCP server.">
      ...
      <div class="content-container">
          ...
          <div class="header container">
            <div class="mcp-meta">
              ...
              <div class="header-content">
                <div class="mcp-name">parcelio-mcp</div>
            ...
            <div class="header-actions">
              ...
              <div class="popover">
                ...
                <div class="popover-menu hidden" id="popover-menu">
                  <a class="popover-button install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=ParcelioMcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJwYXJjZWxpby1tY3AiLCJzdGFydCIsIi0tc2VydmVyLWluZGV4IiwiMCIsIi0tYXBpLWtleS1hdXRoIiwiIiwiLS1iZWFyZXItYXV0aCIsIiJdfQ==">
                    Cursor
                  </a>
                  ...
                  <a class="popover-button install-link" href="vscode://ms-vscode.vscode-mcp/install?name=ParcelioMcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJwYXJjZWxpby1tY3AiLCJzdGFydCIsIi0tc2VydmVyLWluZGV4IiwiMCIsIi0tYXBpLWtleS1hdXRoIiwiIiwiLS1iZWFyZXItYXV0aCIsIiJdfQ==">
                    VS Code
                  </a>
        ...
        <section class="install container">
          ...
          <div class="install-targets">
            <a tabindex="0" class="card install-target install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=ParcelioMcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJwYXJjZWxpby1tY3AiLCJzdGFydCIsIi0tc2VydmVyLWluZGV4IiwiMCIsIi0tYXBpLWtleS1hdXRoIiwiIiwiLS1iZWFyZXItYXV0aCIsIiJdfQ==">
              <div class="target">
            ...
            <a tabindex="0" class="card install-target install-link" href="vscode://ms-vscode.vscode-mcp/install?name=ParcelioMcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJwYXJjZWxpby1tY3AiLCJzdGFydCIsIi0tc2VydmVyLWluZGV4IiwiMCIsIi0tYXBpLWtleS1hdXRoIiwiIiwiLS1iZWFyZXItYXV0aCIsIiJdfQ==">
              <div class="target">
    ...
    <div class="modal" id="claude-code-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="claude-cli-cmd">claude mcp add ParcelioMcp -- npx -y parcelio-mcp start --server-index 0 --api-key-auth  --bearer-auth </code>
        </div>
      </div>
    </div>
    ...
    <div class="modal" id="gemini-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="gemini-config">gemini mcp add ParcelioMcp -- npx -y parcelio-mcp start --server-index 0 --api-key-auth  --bearer-auth </code>
        </div>
      </div>
    </div>
