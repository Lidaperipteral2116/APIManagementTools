...
export interface Env {
  PARCELIOMCP_API_KEY_AUTH?: string | undefined;
  PARCELIOMCP_BEARER_AUTH?: string | undefined;

  PARCELIOMCP_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env> = z.object({
  PARCELIOMCP_API_KEY_AUTH: z.string().optional(),
  PARCELIOMCP_BEARER_AUTH: z.string().optional(),

  PARCELIOMCP_DEBUG: z.coerce.boolean().optional(),
});
