...
import {
  PickupCreate,
  PickupCreate$zodSchema,
} from "../models/pickupcreate.js";
import { APICall, APIPromise } from "../types/async.js";
import { Result } from "../types/fp.js";

export enum SchedulePickupAcceptEnum {
 ...
 */
export function pickupsSchedulePickup(
...
async function $do(
  ...
  request: PickupCreate,
  options?: RequestOptions & {
    acceptHeaderOverride?: SchedulePickupAcceptEnum;
  },
): Promise<
  [
    Result<
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => PickupCreate$zodSchema.parse(value$),
