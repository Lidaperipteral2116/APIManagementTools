...
import {
  AddPackageRequest,
  AddPackageRequest$zodSchema,
} from "../models/addpackageop.js";
...
export enum AddPackageAcceptEnum {
 ...
 * `409`.
 */
export function packagesAddPackage(
...
async function $do(
  client$: ParcelioMcpCore,
  request: AddPackageRequest,
  options?: RequestOptions & { acceptHeaderOverride?: AddPackageAcceptEnum },
): Promise<
  [
    Result<
      Response,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => AddPackageRequest$zodSchema.parse(value$),
