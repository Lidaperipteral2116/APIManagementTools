...
import {
  ...
  CancelShipmentRequest$zodSchema,
} from "../models/cancelshipmentop.js";
 ...
 */
export function shipmentsCancelShipment(
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CancelShipmentRequest$zodSchema.parse(value$),
