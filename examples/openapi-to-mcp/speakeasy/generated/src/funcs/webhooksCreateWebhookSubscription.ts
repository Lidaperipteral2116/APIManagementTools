...
import {
  ...
  WebhookSubscriptionCreate$zodSchema,
} from "../models/webhooksubscriptioncreate.js";
import { APICall, APIPromise } from "../types/async.js";
import { Result } from "../types/fp.js";

export enum CreateWebhookSubscriptionAcceptEnum {
...
async function $do(
  ...
  request: WebhookSubscriptionCreate,
  options?: RequestOptions & {
    acceptHeaderOverride?: CreateWebhookSubscriptionAcceptEnum;
  },
): Promise<
  [
    Result<
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => WebhookSubscriptionCreate$zodSchema.parse(value$),
